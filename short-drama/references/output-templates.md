...
- **声音指纹 + voice 样本集**（供 /分集 生成时作为正向召回锚点，不是金句库）：
  ...
  - 台词要真能让该角色说出口，覆盖不同场景/情绪，不是 5 条同义重复；遮住角色名仍应能听出是谁
...
|----------------|---------|---------|---------|-----|
| {角色A} | 无 | {公开/私下称呼} | {公开/私下称呼} | ... |
| {角色B} | {公开/私下称呼} | 无 | {公开/私下称呼} | ... |
| {角色C} | {公开/私下称呼} | {公开/私下称呼} | 无 | ... |
| ... | ... | ... | ... | ... |
...
/仿写 状态 DIR   只读查看复刻项目进度、已生成文件和下一步
...
/导出 N          只需交付单集时用：导出第 N 集正文 .docx，不含人物小传/梗概
...
/市场 <平台>     实时榜单调研：6 板块报告（TOP 15 / 题材分布 / 人设热力 / 金手指 / 改编信号 / 操盘建议）
                 示例：/市场 红果 近14天 | /市场 番茄 男频 | /市场 抖音漫剧
